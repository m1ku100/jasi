...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('twist/favicon.ico')}}" >

    <!-- <link href='https://fonts.googleapis.com/css?family=PT+Sans:400,700,400italic,700italic' rel='stylesheet' type='text/css'> -->

    <!-- Animate.css -->
    <link rel="stylesheet" href="{{asset('twist/css/animate.css')}}" >
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="{{asset('twist/css/icomoon.css')}}" >
    <!-- Simple Line Icons -->
    <link rel="stylesheet" href="{{asset('twist/css/simple-line-icons.css')}}" >
    <!-- Bootstrap  -->
    <link rel="stylesheet" href="{{asset('twist/css/bootstrap.css')}}" >
    <!-- Owl Carousel  -->
    <link rel="stylesheet" href="{{asset('twist/css/owl.carousel.min.css')}}" >
    <link rel="stylesheet" href="{{asset('twist/css/owl.theme.default.min.css')}}" >
    <!-- Style -->
    <link rel="stylesheet" href="{{asset('twist/css/style.css')}}">


    <!-- Modernizr JS -->
    <script  src="{{asset('twist/js/modernizr-2.6.2.min.js')}}"></script>

    <script src="{{asset('twist/js/respond.min.js')}}"></script>
...
<!-- jQuery -->
<script src="{{asset('twist/js/jquery.min.js')}}" ></script>
<!-- jQuery Easing -->
<script src="{{asset('twist/js/jquery.easing.1.3.js')}}" ></script>
<!-- Bootstrap -->
<script  src="{{asset('twist/js/bootstrap.min.js')}}" ></script>
<!-- Waypoints -->
<script src="{{asset('twist/js/jquery.waypoints.min.js')}}" ></script>
<!-- Stellar Parallax -->
<script src="{{asset('twist/js/jquery.stellar.min.js')}}" ></script>
<!-- Owl Carousel -->
<script src="{{asset('twist/js/owl.carousel.min.js')}}" ></script>
<!-- Counters -->
<script src="{{asset('twist/js/jquery.countTo.js')}}" ></script>
<!-- Google Map -->
<script  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCefOgb1ZWqYtj7raVSmN4PL2WkTrc-KyA&sensor=false"></script>
<script src="{{asset('twist/js/google_map.js')}}" ></script>
<!-- Main JS (Do not remove) -->
<script src="{{asset('twist/js/main.js')}}" ></script>
